...
select month, month_gains, month_losses, month_gains + month_losses as net_member_growth,
	...
	sum(month_gains + month_losses) over (order by month rows unbounded preceding) as active_members
