...
CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_link_click_1_base as (
  SELECT
    "root_id"          as "root_id",
...
CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_change_form_1_base as (
  SELECT
    "root_id"          as "root_id",
    "value"            as "value",
    "element_classes"  as "element_classes",
...
CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_submit_form_1_base as (
  SELECT
    "root_id"         as "root_id",
...
CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_ua_parser_context_1_base as (
  SELECT
    "root_id"            as "root_id",
...
CREATE OR REPLACE VIEW __ac_snowplow.events_base as (
  SELECT
