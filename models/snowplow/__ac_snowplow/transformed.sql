CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_link_click_1_transformed as (
  SELECT
    "root_id"          as "root_id",
  ...
  FROM
    __ac_snowplow.com_snowplowanalytics_snowplow_link_click_1_filtered
);



CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_change_form_1_transformed as (
  SELECT
    "root_id"          as "root_id",
    "value"            as "value",
    "element_classes"  as "element_classes",
    ...
    "root_tstamp"      as "root_tstamp"
  FROM
    __ac_snowplow.com_snowplowanalytics_snowplow_change_form_1_filtered
);



CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_submit_form_1_transformed as (
  SELECT
    "root_id"         as "root_id",
    ...
    "root_tstamp"     as "root_tstamp"
  FROM
    __ac_snowplow.com_snowplowanalytics_snowplow_submit_form_1_filtered
);



CREATE OR REPLACE VIEW __ac_snowplow.com_snowplowanalytics_snowplow_ua_parser_context_1_transformed as (
  SELECT
    "root_id"            as "root_id",
    ...
    "root_tstamp"        as "root_tstamp"
  FROM
    __ac_snowplow.com_snowplowanalytics_snowplow_ua_parser_context_1_filtered
);



CREATE OR REPLACE VIEW __ac_snowplow.events_transformed as (
  SELECT
