...
CREATE OR REPLACE VIEW segment_analysis.track_transformed as (
  SELECT
    "properties__target_id#6d0e913c078c5914e63f286d5f83ce1e"  as "properties__target_id#6d0e913c078c5914e63f286d5f83ce1e",
    "version"                                                 as "version",
    ...
    "properties__target_id#c831cb584846626333ac4eabead6762f"  as "properties__target_id#c831cb584846626333ac4eabead6762f",
  ...
  FROM
    segment_analysis.track_filtered
);

COMMENT ON TABLE segment_analysis.track_transformed IS 'timeseries,funnel,cohort';



CREATE OR REPLACE VIEW segment_analysis.group_transformed as (
  SELECT
    "version"                    as "version",
    "originaltimestamp"          as "originaltimestamp",
    "sentat"                     as "sentat",
    ...
    "groupid"                    as "groupid"
  FROM
    segment_analysis.group_filtered
);



CREATE OR REPLACE VIEW segment_analysis.identify_transformed as (
  SELECT
    "version"                    as "version",
  ...
  FROM
    segment_analysis.identify_filtered
);



CREATE OR REPLACE VIEW segment_analysis.page_transformed as (
  SELECT
    "version"                    as "version",
    "originaltimestamp"          as "originaltimestamp",
    "sentat"                     as "sentat",
    ...
    "context__ip"                as "context__ip"
  FROM
    segment_analysis.page_filtered
);

COMMENT ON TABLE segment_analysis.page_transformed IS 'timeseries,funnel,cohort';